...
#[Fillable('theme', 'language', 'turnstile_site_key', 'turnstile_secret_key', 'rate_limit_requests', 'company_name', 'company_dni', 'mail_from_address', 'mail_from_name', 'session_timeout_minutes', 'is_maintenance_mode')]
